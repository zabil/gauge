...
func copyGaugeFiles(installPath string) {
	...
	files[filepath.Join("skel", "graph", "index.html")] = filepath.Join("share", gauge, "skel", "graph")
	files[filepath.Join("skel", "graph", "vis.min.css")] = filepath.Join("share", gauge, "skel", "graph")
	files[filepath.Join("skel", "graph", "vis.min.js")] = filepath.Join("share", gauge, "skel", "graph")
